            ...
            <div class="max-w-full max-h-full">
                <form name="formSearch" id="formSearch" method="POST" action="{{route('get-dados')}}">
                    ...
                    <div class="max-w-full grid justify-items-center">
                        ...
                        <input autofocus minlength="6" maxlength="6" type="number" placeholder="Insira o código de pesquisa" id="pacienteid" name="pacienteid" class="input input-bordered input-primary w-full max-w-sm text-lg" />
