...
<div id="report" class="mockup-window border border-base-300">
    <div class="text-center bg-white">
        ...
        <div class="py-10 border border-2">
            <p class="py-2 text-4xl font-bold">Resultado Agendamento Telefone/WhatsApp </p>
            <div class="stats">
        ...
        <div class="py-10 border border-2">
            <p class="py-2 text-4xl font-bold">Resultado Agendamento Recepção </p>
            <div class="stats">
                ...
                <div class="stat">
                    ...
                    <div class="stat-title">Avaliações Respondidas</div>
                    <div class="stat-value text-secondary">{{ $countagendarecep }}</div>
                </div>
                ...
                <div class="stat">
                    ...
                    <div class="stat-title">Notas Positivas</div>
                    <div class="stat-value text-info">{{ $agreceppositivas }}</div>
                </div>
                ...
                <div class="stat">
                    ...
                    <div class="radial-progress text-success" style="--value:{{ $prcntagendarecep }}; --thickness: 5px; ">
                        {{ $prcntagendarecep = number_format($prcntagendarecep, 2, '.', '') }}%
                    </div>
                    <div class="stat-title">De satisfação</div>
                </div>
