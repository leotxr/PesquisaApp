...
<body class="sm:overflow-hidden">
    ...
    <div class="font-sans antialiased text-gray-900 bg-base-200">
        ...
        <div id="toast-danger" class="absolute flex items-center w-full max-w-xs p-4 space-x-4 text-gray-500 bg-white divide-x divide-gray-200 rounded-lg shadow right-5 bottom-5 dark:text-gray-400 dark:divide-gray-700 space-x dark:bg-gray-800" role="alert">
