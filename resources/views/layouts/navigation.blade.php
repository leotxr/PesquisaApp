<nav x-data="{ open: false, atTop: false }" class="bg-white border-b border-gray-100" :class='{"bg-opacity-70": atTop, "shadow-lg": atTop}'>
    <!-- Primary Navigation Menu -->
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8"  @scroll.window="atTop = (window.pageYOffset < 50) ? false: true">
