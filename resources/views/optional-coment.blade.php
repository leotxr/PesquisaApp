        ...
        <div class="hero h-screen bg-base-200">
            <div class="hero-content text-center justify-center">
                <div class="max-w-full">
                    ...
                    <textarea type="text" name="comentario" oninput='if(this.scrollHeight > this.offsetHeight) this.rows += 1' placeholder="Comentários / Sugestões - (Opcional)" class="textarea textarea-primary w-full justify-center mb-10" autofocus></textarea>
