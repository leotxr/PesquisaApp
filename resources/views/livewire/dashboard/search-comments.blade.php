    ...
    <form wire:submit.prevent='search'>
        <div class="grid sm:grid-cols-4 gap-8 text-center content-center bg-white p-4">
            ...
            <div>
                ...
                <input wire:model='initial_date' id="date_1" type="date" class="input input-bordered">
            </div>
            <div>
                <x-input-label for="date_2" class="label">
                    Data Final
                </x-input-label>
                <input wire:model='final_date' id="date_2" type="date" class="input input-bordered">
            </div>
            ...
            <div>
                ...
                <select wire:model='search_status' multiple size="3"
    ...
    <div>
        @isset($comments)
            <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                <div>
                    <div class="flex">
                        <button class="btn btn-success m-4" id="export_table_comments">
                            Excel
                            ...
                            <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                                ...
                                <td class="px-6 py-4 dropdown dropdown-left dropdown-end">
                                    <div class="flex radio-group">
                                        @foreach ($statuses as $status)
                                            @livewire('dashboard.select-status', ['comment' => $comment->rating_id, 'status' => $status], key($comment->rating_id))
                                        @endforeach
                                    </div>
                                </td>
                            </tr>
