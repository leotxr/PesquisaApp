<div>
    ...
    { id: 5, label: 'Relatório de satisfação por setor', link: '{{route("reports.ratings-by-sector")}}' },
    { id: 6, label: 'Relatório de satisfação por funcionário', link: '{{route("reports.satisfaction-by-employee")}}' }
]}">
