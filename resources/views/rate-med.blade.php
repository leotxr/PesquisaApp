            ...
            <div class="hero h-screen bg-base-200" id="us">
                <div class="hero-content text-center">
                    <div class="max-w-full">
                        ...
                        <p class="text-2xl">Como você avalia o atendimento realizado pela recepcionista da Ultra-sonografia
                        </p>
                        <div class="flex justify-center pt-2 text-center">
                            <img src="{{URL::asset('image/funcionarios/').'/' . $us->USUARIO . ('.png')}}" class="scale-100 max-h-40 max-w-40 justify-center"></img>
                        </div>
            ...
            <div class="hero h-screen bg-base-200" id="enf">
                <div class="hero-content text-center">
                    <div class="max-w-full">
                        ...
                        <div class="flex justify-center pt-2 text-center">
                            <img src="{{URL::asset('image/funcionarios/').'/' . $enf->ENFERMEIRA . ('.png')}}" class="scale-100 max-h-40 max-w-40 justify-center"></img>
                        </div>
            ...
            <div class="hero h-screen bg-base-200" id="setor">
                <div class="hero-content text-center">
                    <div class="max-w-full">
                        ...
                        <div class="flex justify-center pt-2 text-center">
                            <img src="{{URL::asset('image/funcionarios/').'/' . $requisicao->TECNICO . ('.png')}}" class=" scale-100 max-h-40 max-w-40 justify-center"></img>
                        </div>
                        <p for="mask" class="text-3xl font-bold">{{$requisicao->TECNICO}}</p>
                        @else
                        <p class="text-2xl">realizado pelo(a) médico(a)</p>
                        <div class="flex justify-center pt-2 text-center">
                            <img src="{{URL::asset('image/medicos/').'/' . $requisicao->MEDICO . ('.png')}}" class="rounded-sm scale-100 max-h-40 max-w-40 justify-center"></img>
                        </div>
                        ...
                        <input type="text" class="text-3xl font-bold" id="requisicao_id" name="requisicao_id[]" value="{{$requisicao_id}}" style="display: none;"></input>
