...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'extmysql' => [
            'driver' => 'mysql',
            'url' => env('192.185.213.43'),
            'host' => env('DB_HOST3', '192.185.213.43'),
        ...
        'sqlsrv' => [
            'driver' => 'sqlsrv',
            'url' => env('DATABASE_URL'),
            'host' => env('DB_HOST2', '192.168.254.250'),
            'port' => env('DB_PORT2', '1433'),
            'database' => env('DB_DATABASE2', 'BASE_UBA'),
            'username' => env('DB_USERNAME2', 'sa'),
            'password' => env('DB_PASSWORD2', 'Ult2*.0'),
            'charset' => 'utf8',
            'prefix' => '',
            'prefix_indexes' => true,
